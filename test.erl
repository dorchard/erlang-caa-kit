...
recv_test(0) ->
    caa:main("testing_files/recv.erl", "recv/2", "testing_files/"),
...
recv_test(X) -> 
    ...
    caa:main("testing_files/recv.erl", Fun ++ "/2", "testing_files/"),
    {ok, Result} = file:read_file("testing_files/graph.dot"),
...
call_test(0) -> 
    caa:main("testing_files/call.erl", "call/2", "testing_files/"),
    {ok, Result} = file:read_file("testing_files/graph.dot"),
...
call_test(X) -> 
    ...
    caa:main("testing_files/call.erl", Fun ++ "/2", "testing_files/"),
    {ok, Result} = file:read_file("testing_files/graph.dot"),
...
random_test(0) ->
    caa:main("testing_files/examples.erl", "e/1", "testing_files/"),
    {ok, Result} = file:read_file("testing_files/graph.dot"),
...
random_test(9) ->
    caa:main("testing_files/examples.erl", "e9/3", "testing_files/"),
    {ok, Result} = file:read_file("testing_files/graph.dot"),
...
random_test(X) -> 
    ...
    caa:main("testing_files/examples.erl", Fun ++ "/2", "testing_files/"),
    {ok, Result} = file:read_file("testing_files/graph.dot"),
...
clause_test(0) -> 
    caa:main("testing_files/clause.erl", "c/3", "testing_files/"),
    {ok, Result} = file:read_file("testing_files/graph.dot"),
...
clause_test(X) -> 
    ...
    caa:main("testing_files/clause.erl", Fun ++ "/3", "testing_files/"),
    {ok, Result} = file:read_file("testing_files/graph.dot"),
...
function_test(0) -> 
    caa:main("testing_files/function.erl", "f/2", "testing_files/"),
    {ok, Result} = file:read_file("testing_files/graph.dot"),
...
function_test(X) -> 
    ...
    caa:main("testing_files/function.erl", Fun ++ "/2", "testing_files/"),
    {ok, Result} = file:read_file("testing_files/graph.dot"),
...
case_test(0) -> 
    caa:main("testing_files/case_of.erl", "c/1", "testing_files/"),
    {ok, Result} = file:read_file("testing_files/graph.dot"),
...
case_test(X) -> 
    Fun = lists:flatten(io_lib:format("c~p", [X])),
    caa:main("testing_files/case_of.erl", Fun ++ "/1", "testing_files/"),
    {ok, Result} = file:read_file("testing_files/graph.dot"),
...
createTestFiles(recv, 0) ->
    ...
    caa:main("testing_files/recv.erl", Fun ++ "/2", "testing_files/receive_examples/"),
...
createTestFiles(call, 0) ->
    ...
    caa:main("testing_files/call.erl", Fun ++ "/2", "testing_files/call_examples/"),
    Filename = lists:flatten(io_lib:format("~s~s", [Fun, "\~2"])),
...
createTestFiles(random, 0) ->
    ...
    caa:main("testing_files/examples.erl", Fun ++ "/1", "testing_files/random_examples/"),
...
createTestFiles(random, 9) -> 
    ...
    caa:main("testing_files/examples.erl", Fun ++ "/3", "testing_files/random_examples/"),
...
createTestFiles(random, X) -> 
    Fun = lists:flatten(io_lib:format("e~p", [X])),
    caa:main("testing_files/examples.erl", Fun ++ "/2", "testing_files/random_examples/"),
    Filename = lists:flatten(io_lib:format("~s~s", [Fun, "\~2"])),
    Cmd = lists:flatten(io_lib:format("move testing_files\\random_examples\\graph.dot testing_files\\random_examples\\~s.dot", [Filename])),
    os:cmd(Cmd),
...
createTestFiles(function, 0) ->
    ...
    caa:main("testing_files/function.erl", Fun ++ "/2", "testing_files/function_examples/"),
    Filename = lists:flatten(io_lib:format("~s~s", [Fun, "\~2"])),
...
createTestFiles(clause, 0) ->
    ...
    caa:main("testing_files/clause.erl", Fun ++ "/3", "testing_files/clause_examples/"),
    Filename = lists:flatten(io_lib:format("~s~s", [Fun, "\~3"])),
...
createTestFiles(case_of, 0) ->
    Fun = lists:flatten(io_lib:format("c", [])),
    caa:main("testing_files/case_of.erl", Fun ++ "/1", "testing_files/case_examples/"),
    Filename = lists:flatten(io_lib:format("~s~s", [Fun, "\~1"])),
